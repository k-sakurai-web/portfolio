      ...
      <div id="topView">
        <div class="topInner">
          <div class="inspiro-slider">
            ...
            <img class="fadeInTop" src="<?php echo esc_url(get_template_directory_uri() . '/img/topMessage.svg'); ?>" alt="topMessage" />
            </div>
          </div>
          <!-- スクロール誘導 -->
        ...
        <div class="contents-pageInner">
          <section id="about">
            <div class="about-inner wrapper">
              ...
              <div id="profile">
                ...
                <div class="profText">
                  ...
                  <ul>
                    <li>ホームページ制作(HTML,CSS,JavaScript,WordPress)</li>
                    <li>ランディングページ制作(HTML,CSS,JavaScript,WordPress)</li>
                  </ul>
                </div>
                <!--  profText -->
              </div>
            ...
            <div class="messageBox">
              <ul class="msgSlick">
                <li class="slickItem">K SAKURAI</li>
                <li class="slickItem">K SAKURAI</li>
                <li class="slickItem">K SAKURAI</li>
              </ul>
              <!--  .msgSlick -->
